...
import ru.myx.ae3.l2.xhtml.XhtmlDomTargetContext;
import ru.myx.ae3.serve.ServeRequest;
import ru.myx.sapi.FormatSAPI;

/** @author myx */
public class WebContextXhtml extends XhtmlDomTargetContext implements WebContext<XhtmlDomTargetContext> {

	ServeRequest query;
	
	/** @param target
	 * @param query */
	public WebContextXhtml(final TargetInterface target, final ServeRequest query) {
	...
	public ReplyAnswer getResultReply() {
		...
		return Reply.binary("WebContextXhtml", this.query, collector.toCloneFactory()) //
