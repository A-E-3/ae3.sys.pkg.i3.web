...
@ReflectionIgnore
final class QueryHttpEmpty extends QueryHttp<QueryHttpEmpty> implements UniversalServeRequest<QueryHttpEmpty> {
	...
	@Deprecated
	@Override
	public QueryHttpEmpty toBinary() {
	...
	@Deprecated
	@Override
	public QueryHttpEmpty toCharacter() {
