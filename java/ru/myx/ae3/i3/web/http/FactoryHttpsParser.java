 ...
 */
/** @author myx */
public final class FactoryHttpsParser implements ObjectFactory<TransferSocket, BaseMessage> {
	...
	private static final String[] VARIETY = {
			"https_parser", HttpProtocol.PNAME_HTTPS
	};
	...
	public final ObjectTarget<TransferSocket> connect(final String variant, final BaseObject attributes, final Class<?> source, final ObjectTarget<BaseMessage> target) {
		...
		return new TargetHttps(target, ignoreTargetPort, ignoreGzip, ignoreKeepAlive, reverseProxied, ifModifiedSinceMode);
	}
	...
	public final Class<?>[] sources() {
		...
		return FactoryHttpsParser.SOURCES;
	}

	@Override
	public final Class<?>[] targets() {

		return FactoryHttpsParser.TARGETS;
	}

	@Override
	public final String[] variety() {

		return FactoryHttpsParser.VARIETY;
	}
}
